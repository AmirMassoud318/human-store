...
export default function ProductPage() {
  ...
  function handleAddToBag() {
    ...
    if (!variant || !product || variant.stock <= 0) return;
      ...
      <main className="product-main">
        ...
        <div className="pdp-info">
          ...
          <button
            ...
            style={{ width: "100%", border: "none", marginBottom: 12, opacity: outOfStock ? 0.5 : 1, cursor: outOfStock ? "not-allowed" : "pointer" }}
            onClick={handleAddToBag}
            disabled={!selectedSize || !selectedColor || outOfStock}
          >
            {outOfStock ? d.outOfStock : justAdded ? d.added : d.addtobag}
          </button>
